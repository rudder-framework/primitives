...
def test_autocorr_method():
    ...
    from pmtvs.embedding.delay import optimal_delay
...
def test_time_delay_embedding():
    ...
    from pmtvs.embedding.delay import time_delay_embedding
...
def test_optimal_dimension():
    ...
    from pmtvs.embedding.delay import optimal_dimension
